...
class CalculatorUI:
    ...
    def display_menu(self):
        ...
        print("12. Sine (sin)")
        print("13. Cosine (cos)")
        print("14. Tangent (tan)")
        print("\n--- LOGARITHMIC ---")
        print("15. Logarithm (log)")
        ...
        print("19. Factorial (!)")
        print("\n--- ADVANCED ---")
        print("20. Combination (nCr)")
        print("21. Permutation (nPr)")
        print("22. GCD")
        print("23. LCM")
        print("\n--- HISTORY & UTILITIES ---")
        print("24. View History")
        print("25. Clear History")
        print("26. Round Number")
        print("27. Convert to Percentage")
        print("\n0.  Exit")
        print("="*70)
    ...
    def handle_trigonometric_operations(self, choice: str):
        """Handle trigonometric operations"""
        try:
            angle = self.get_single_number("Enter angle in degrees:")
            if angle is None:
                return
    ...
    def run(self):
        ...
        while self.running:
            self.display_menu()
            choice = input("Enter your choice (0-27): ").strip()
            ...
            if choice == '0':
                ...
                self.handle_trigonometric_operations(choice)
